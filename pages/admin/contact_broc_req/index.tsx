...
} from "@/components/table/admin/contact_broc_req/TableHeads";
import {
  getContactBrocReq,
  deleteContactBrocReq,
  deleteAllContactBrocReq,
  getContactBrocReqById,
} from "@/features/admin/contact_broc_req";
import saveAsExcel from "@/features/admin/contact_broc_req/export";
import exportPDFPublic from "@/features/admin/contact_broc_req/export_pdf";
...
const Contact: NextPage = () => {
  ...
  const { data } = appSelector((state) => state.contact_broc_req);
  ...
  // *************************** Use Effect ***************************
  React.useEffect(() => {
    dispatch(getContactBrocReq(""));
  }, [dispatch]);

  React.useEffect(() => {
    dispatch(getContactBrocReq(searched));
  }, [dispatch, searched]);
  // *************************** Use Effect ***************************
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire("Deleted!", "Your data has been deleted.", "success").then(
          function () {
            dispatch(deleteContactBrocReq(data)).then((result: any) => {
              dispatch(getContactBrocReq(""));
            });
          }
        );
  ...
  const DeleteAll = (id: any) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire("Deleted!", "Your data has been deleted.", "success").then(
          function () {
            dispatch(deleteAllContactBrocReq(id)).then((result: any) => {
              dispatch(getContactBrocReq(""));
            });
          }
        );
  ...
  const exportspdf = (id: any) => {
    dispatch(getContactBrocReqById(id)).then((value: any) => {
      exportPDFPublic({
        rows: [
          {
